...
object WeaponDAO {
  ...
  /**
    * Finds all weapons which are in the faction and have the linkedName
    * @param faction the name of the faction the weapons belong to
    * @param linkedName the linked name of the weapon to search for
    * @return
    */
